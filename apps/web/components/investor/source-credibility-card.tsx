      ...
      <CardContent className="space-y-4">
        ...
        <dl className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
          <div>
            ...
            <dd className="font-medium text-neutral-900 dark:text-neutral-50">{countyName} County foreclosure notice</dd>
          </div>
          <div>
            <dt className="text-neutral-500">County appraisal source</dt>
            <dd className="font-medium text-neutral-900 dark:text-neutral-50">{countyName} County Appraisal District</dd>
          </div>
          <div>
            <dt className="text-neutral-500">Appraisal year</dt>
            <dd className="font-medium text-neutral-900 dark:text-neutral-50">{listing.appraisalYear ?? "Unavailable"}</dd>
          </div>
          <div>
        ...
        {listing.hasSourceDocument ? (
          canViewSource && sourceUrl ? (
            <Link href={sourceUrl} target="_blank" rel="noreferrer" className="inline-flex text-sm font-medium text-brand-700 hover:underline dark:text-brand-400">
              View Original Notice →
            </Link>
          ) : (
            <Link href="/pricing" className="inline-flex text-sm font-medium text-brand-700 hover:underline dark:text-brand-400">
        ...
        <p className="border-t border-neutral-100 pt-3 text-xs text-neutral-400 dark:border-neutral-800">
